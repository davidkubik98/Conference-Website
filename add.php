  ...
  <section class="section-margin">
    <div class="container">
      <div class="section-intro text-center pb-90px">
        <p class="section-intro__title">Enter the user's information below</p>
	...
	<form method="post">
		...
		<input type="text" name="committee" id="committee">
        <br>
        <label for="chairLabel">Is Chair Of Commitee?</label>
		<select name="chair">
			<option value="true"> YES </option>
			<option value="false"> NO </option>
		</select>
        <br>
        <label for='fee'>Did Student Pay? </label>
		<select name="paid">
			<option value="true"> YES </option>
			<option value="false"> NO </option>
		</select>
