...
<body>
  ...
  <section class="section-margin">
    <div class="container">
      <div class="section-intro text-center pb-90px">
        <p class="section-intro__title">Enter the Room Number</p>
        <h2 class="primary-text">Find A Hotel Room</h2>
  ...
  <body>
	...
	<?php
	    ...
	    try{
				 $room = (int)$_POST['room'] ;
				 $sql = "SELECT name FROM student where room_num=?";
			   $result = $pdo->prepare($sql);
				 $result->execute([$room]);
	        if($result->rowCount() > 0){ ?>
						<h2> Students in Room <?php echo $room ?></h2> <?php
	            echo "<table>";
	                echo "<tr>";
	                    echo "<th>Name</th>";
	                echo "</tr>";
